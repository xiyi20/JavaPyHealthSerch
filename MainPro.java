...
class UserHome{
    public UserHome(){
        ...
        String[] p3buttonTexts = {"气胸","胸痛","心悸","男性乳房发育症","乳汁分泌减少","乳糜尿","乳溢一高泌乳素血症","心包积液", 
        ...
        String[] p4buttonTexts = {"腹痛","腹水","腹泻","肺水肿","腹部肿块","肝肿大","胃肠气胀","胃食管反流性疾病", 
            "肾病综合征","慢性肾衰竭","急性肾衰竭"};
        ...
        String[] p7buttonTexts = {"血尿","糖尿","黑便","少尿","尿失禁与遗尿","尿频伴尿急和尿痛","排尿困难及尿潴留", 
        ...
        String[] p9buttonTexts = {"低血压","低镁血症","低钠血症","低钾血症","低钙血症","低血糖症","代谢性酸中毒","低颅压综合征", 
